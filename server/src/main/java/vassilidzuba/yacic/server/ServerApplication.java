...
public class ServerApplication extends Application<ServerConfiguration> {
	...
	private void initResources(JerseyEnvironment jersey, ServerConfiguration configuration) {
        ...
        jersey.register(new ProjectRunResource(configuration.getPipelines(), configuration.getPodmanActionDefinitions(), configuration.getProjectDirectory(), configuration.getNodes()));
